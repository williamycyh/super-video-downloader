...
/**
 * 兼容Python版本的BubeDLRequest类
 */
public class BubeDLRequest {
    private List<String> urls;
    private DownloadOptions options;
    private List<String> customCommands;
    
    public BubeDLRequest(String url) {
    ...
    public BubeDLRequest(List<String> urls) {
     ...
     * 添加选项（兼容Python版本的方法名）
     */
    public BubeDLRequest addOption(String option, String argument) {
        switch (option) {
            case "--format":
            case "-f":
     ...
     * 添加选项（数字参数）
     */
    public BubeDLRequest addOption(String option, Number argument) {
     ...
     * 添加选项（无参数）
     */
    public BubeDLRequest addOption(String option) {
        switch (option) {
            case "--no-cache-dir":
                options.setNoCacheDir(true);
                break;
     ...
     * 添加自定义命令
     */
    public BubeDLRequest addCommands(List<String> commands) {
