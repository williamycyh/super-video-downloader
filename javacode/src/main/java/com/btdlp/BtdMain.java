...
public class BtdMain {
    ...
    public static void main(String[] args) {
        ...
        // 创建主下载器
        BtdJava ytdlp = new BtdJava(options);
        
        // 设置进度回调
        ytdlp.addProgressCallback(new BtdJava.ProgressCallback() {
            @Override
        ...
        for (String url : urls) {
            try {
                ...
                if ("true".equals(options.get("list-formats"))) {
                    ...
                    // 实际下载
                    BtdJava.DownloadResult result = ytdlp.download(url);
     ...
     * 列出可用格式
     */
    private static void listFormats(BtdJava ytdlp, String url) {
     ...
     * 模拟下载
     */
    private static void simulateDownload(BtdJava ytdlp, String url) {
    ...
    private static void printUsage() {
        ...
        System.out.println("  java -cp . com.btdlp.BtdMain [选项] URL [URL ...]");
        System.out.println();
        ...
        System.out.println("  java -cp . com.btdlp.BtdMain https://www.facebook.com/watch/?v=123456789");
        System.out.println("  java -cp . com.btdlp.BtdMain -f 720p -o 'video_%(title)s.%(ext)s' https://www.instagram.com/p/ABC123/");
        System.out.println("  java -cp . com.btdlp.BtdMain --list-formats https://www.tiktok.com/@user/video/123456789");
        System.out.println("  java -cp . com.btdlp.BtdMain --simulate https://www.pornhub.com/view_video.php?viewkey=123456789");
        System.out.println();
        System.out.println("支持的平台:");
        for (String platform : BtdJava.getSupportedPlatforms()) {
