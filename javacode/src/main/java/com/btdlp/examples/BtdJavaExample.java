 ...
 * BtdJava使用示例
 */
public class BtdJavaExample {
    
    public BtdJavaExample() {
    }
    
    public static void main(String[] args) {
        System.out.println("=== BtdJava 使用示例 ===\n");
    ...
    public static void advancedExample() {
        ...
        try {
            ...
            BtdJava.DownloadResult result = ytdlp.download(url, outputPath);
