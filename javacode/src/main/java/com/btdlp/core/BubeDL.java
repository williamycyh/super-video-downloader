...
import com.btdlp.options.BubeDLOptions;
...
/**
 * Core BubeDL class for video extraction and downloading
 */
public class BubeDL {
    private static BubeDL instance;
    private BubeDLOptions params;
    private Logger logger;
    private ExtractorRegistry extractorRegistry;

    private BubeDL() {
        this.logger = new Logger(true, true, true);  // 启用所有日志级别
        this.params = new BubeDLOptions();
        this.extractorRegistry = new ExtractorRegistry();
    }

    public static BubeDL getInstance() {
        if (instance == null) {
            instance = new BubeDL();
        }
        return instance;
    ...
    public BubeDLOptions getParams() {
        return params;
    }

    public void setParams(BubeDLOptions params) {
        this.params = params;
    }
    ...
    private boolean downloadWithHlsDownloader(VideoFormat format, String outputPath, String title) throws Exception {
        try {
            ...
            com.btdlp.downloader.hls.HlsDownloader hlsDownloader = new com.btdlp.downloader.hls.HlsDownloader();
    ...
    private boolean downloadWithHttpDownloader(VideoFormat format, String outputPath, String title) throws Exception {
        try {
            ...
            com.btdlp.downloader.http.HttpDownloader httpDownloader = new com.btdlp.downloader.http.HttpDownloader();
