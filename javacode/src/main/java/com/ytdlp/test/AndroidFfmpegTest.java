...
public class AndroidFfmpegTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 创建Android FFmpeg下载器
            com.ytdlp.downloader.hls.AndroidFfmpegHlsDownloader androidFfmpeg = 
            ...
            if (isAvailable) {
                ...
                if (success) {
                    ...
                    // 测试回退机制
                    System.out.println("\n🔄 测试回退机制...");
                    YtDlpJava.DownloadResult fallbackResult = ytdlpJava.download(testUrl, outputPath + ".fallback");
